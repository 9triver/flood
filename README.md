...
- [内核重设计：操作系统语义](docs/domain-os/06-内核重设计-操作系统语义.md) —— **当前架构**的设计判断、纪律与进展
- [产品定义与核心运行模型](docs/domain-os/00-产品定义与核心运行模型.md) ～ [05] —— 第一代内核的历史文档（已被 dos 取代，保留作决策记录）
- [既有水利应用技术方案](docs/技术方案.md) —— 数据集与原始演示应用
